...
static dispatch_once_t _infinit_email_predicate_token = 0;
...
{
  dispatch_once(&_infinit_email_predicate_token, ^
  {
    static NSString* regex_str =
      @"(?:[a-z0-9!#$%\\&'*+/=?\\^_`{|}~-]+(?:\\.[a-z0-9!#$%\\&'*+/=?\\^_`{|}"
  ...
  return _infinit_email_predicate;
}
